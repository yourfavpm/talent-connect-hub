                ...
                <div className="container max-w-[1000px] mx-auto">
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                        <div className="grid grid-cols-2 md:grid-cols-3 bg-slate-50 border-b border-slate-200">
                            ...
                            <div className="hidden md:block p-6 text-sm font-bold uppercase tracking-widest text-blue-600">Taskive Managed</div>
                        </div>
                        {[
                            ...
                            { m: "Operational coordination", t: "Client managed", v: "Taskive facilitated" }
                        ].map((row, i) => (
                ...
                <div className="container max-w-[1200px] mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 relative">
                        ...
                        <div className="space-y-4">
                            ...
                            {[
                                { q: "Are there any upfront activation fees?", answer: "No. Taskive does not charge setup or search fees. You only pay for talent once an engagement begins or a hire is finalized." },
                        ...
                        <div className="space-y-4">
                            ...
                            {[
                                { q: "How is global payroll managed?", answer: "Taskive acts as the Employer of Record for offshore talent, handling all local taxes, benefits, and labor laws. You pay one invoice." },
