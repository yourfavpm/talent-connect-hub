...
const ServiceModels = () => {
    return (
        <div className="bg-background min-h-screen text-foreground selection:bg-primary selection:text-white pb-0">
            ...
            <section className="relative pt-32 pb-16 md:pt-32 md:pb-24 px-6 bg-white border-b border-slate-100 font-inter overflow-hidden">
            ...
            <section className="py-24 px-6 bg-white font-inter" id="engagement-models">
                <div className="container max-w-[1200px] mx-auto">
                    <div className="text-center mb-20 animate-slide-up">
                        ...
                        <h2 className="text-3xl md:text-5xl font-semibold text-slate-900 mb-6 tracking-tight">Three Structured Ways to Work With Taskive</h2>
                        ...
                        <div className="py-12 lg:px-10 flex flex-col items-start bg-white hover:bg-slate-50/30 transition-colors group">
                            ...
                            <div className="space-y-10 w-full mb-16">
                                <div>
                                    ...
                                    <p className="text-sm text-slate-800 font-medium leading-relaxed">Full-time employment transfer. Taskive performs the search and vetting; you hire onto your payroll.</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-800 font-medium leading-relaxed">Long-term alignment. 120-day replacement guarantee provided by Taskive for every placement.</p>
                                </div>
                                <div>
                ...
                <div className="container max-w-[1200px] mx-auto">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 relative">
                        ...
                        <div className="space-y-4">
                            ...
                            {[
                                { 
                                    q: "What makes Taskive different?", 
                                    a: "Unlike generic marketplaces, Taskive focus on structured, managed engagements. We handle the vetting, compliance, and ongoing coordination, allowing you to focus purely on execution and outcomes." 
                                },
                                { 
                        ...
                        <div className="space-y-4">
                            ...
                            {[
                                { 
                                    q: "Does Taskive handle compliance and payroll?", 
                                    a: "Yes. Taskive manages all international compliance, contractor administration, and multi-currency payroll, providing you with a single, consolidated monthly bill." 
                                },
                                { 
                                ...
                                { 
                                    ...
                                    a: "Taskive is designed to complement existing teams. We provide specialized skills or additional capacity that integrates directly into your existing project management and communication tools." 
                                },
                                { 
