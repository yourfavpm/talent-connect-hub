...
const ClientTicketDetail = () => {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-20 animate-fade-in w-full max-w-none">
      
      {/* Header Breadcrumb */}
      <Link to={getInternalPath("/client/support")} className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-900 transition-colors">
