...
const AcademyHome = () => {
  ...
  return (
    <div className="bg-white min-h-screen text-slate-900 font-inter">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 px-6 overflow-hidden bg-slate-900 text-white">
        ...
        <div className="container max-w-[1200px] mx-auto relative z-10 text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="flex-1 animate-slide-up">
              <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 md:mb-8 leading-[1.1]">
                Build AI-Powered Operational Skills. <br />
                <span className="text-blue-400">Access Global Work.</span>
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-300 mb-8 md:mb-12 max-w-2xl leading-relaxed font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Link to="/courses" className="w-full sm:w-auto">
                  <Button size="lg" className="h-14 px-10 text-base bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-all font-semibold w-full">
                    Browse Courses
                  </Button>
                </Link>
                <Link to="/marketplace" className="w-full sm:w-auto">
                  <Button variant="outline" size="lg" className="h-14 px-8 text-base border-white/20 text-white hover:bg-white/5 rounded-full font-semibold flex items-center justify-center gap-2 w-full">
                    Join Talent Marketplace <ArrowRight className="w-4 h-4" />
                  </Button>
                </Link>
              </div>
      ...
      <section className="py-12 border-b border-slate-100 bg-white">
        <div className="container max-w-7xl mx-auto px-6 text-center">
          <p className="text-[11px] font-bold text-slate-400 uppercase tracking-[0.2em] mb-10">Master the Stack of the Global Economy</p>
          <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-500">
            {["Zapier", "Notion", "Make.com", "Airtable", "GPT-4", "ClickUp"].map((tool) => (
              <span key={tool} className="text-xl md:text-2xl font-bold text-slate-800 tracking-tight">{tool}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-slate-50 border-b border-slate-100">
        <div className="container max-w-[1100px] mx-auto">
          <div className="text-center mb-20 animate-slide-up">
            ...
            <p className="text-sm sm:text-base md:text-base lg:text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
              {[
                ...
                <div key={i} className="flex flex-col items-center text-center">
                  <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${item.color} border-2 border-white shadow-lg flex items-center justify-center mb-6 relative group hover:shadow-2xl transition-all duration-300`}>
                    {(() => {
                      switch(i) {
                        case 0: return <item.icon className="w-10 h-10 text-purple-600" />;
                        case 1: return <item.icon className="w-10 h-10 text-blue-600" />;
                        case 2: return <item.icon className="w-10 h-10 text-emerald-600" />;
                        case 3: return <item.icon className="w-10 h-10 text-orange-600" />;
                        default: return <item.icon className="w-10 h-10 text-blue-600" />;
                      }
                    })()}
      ...
      <section className="py-24 px-6 bg-white overflow-hidden">
        <div className="container max-w-[1200px] mx-auto">
          <div className="bg-slate-900 rounded-[32px] overflow-hidden flex flex-col lg:flex-row relative">
            <div className="lg:w-1/2 p-12 md:p-16 flex flex-col justify-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-[10px] font-bold tracking-widest uppercase mb-6">Flagship Course</div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 md:mb-8 leading-[1.1]">
                    {flagshipCourse.title}
                </h2>
                <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-300 mb-10 md:mb-12 leading-relaxed max-w-xl font-medium">
                ...
                <Link to={`/courses/${flagshipCourse.slug}`}>
                    <Button size="lg" className="h-14 px-10 text-base bg-blue-600 hover:bg-blue-700 text-white rounded-full transition-all font-semibold w-full sm:w-auto">
