...
export const InterviewInviteDrawer = ({ 
  ...
  const handleSubmit = async () => {
    if (!selectedJobId || !date || !time) {
      toast({
        title: "Information required",
        description: "Please select a job, date, and time for the interview.",
        variant: "destructive"
      });
      return;
    }
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8">
          {success ? (
            ...
            <>
              ...
              {/* Time Selection */}
              <div className="space-y-3">
                <Label htmlFor="time" className="text-sm font-semibold text-gray-700">Proposed Time (ST)</Label>
              ...
              <div className="space-y-3">
                ...
                <Textarea 
                  ...
                  className="min-h-[120px] border-gray-200 focus:ring-blue-500 resize-none"
                  value={message}
